@import "http://172.17.10.24:8081/test/browser/less/modify-this.css";
@import "http://172.17.10.24:8081/test/browser/less/modify-again.css";
.modify {
  my-url: url("http://172.17.10.24:8081/test/browser/less/a.png");
}
.modify {
  my-url: url("http://172.17.10.24:8081/test/browser/less/b.png");
}
.gray-gradient {
...
@font-face {
  ...
  src: local(Futura-Medium), url(http://172.17.10.24:8081/test/browser/less/fonts.svg#MyGeometricModern) format("svg");
  not-a-comment: url(//z);
}
#shorthands {
...
#misc {
  background-image: url(http://172.17.10.24:8081/test/browser/less/images/image.jpg);
}
#data-uri {
...
.comma-delimited {
  background: url(http://172.17.10.24:8081/test/browser/less/bg.jpg) no-repeat, url(http://172.17.10.24:8081/test/browser/less/bg.png) repeat-x top left, url(http://172.17.10.24:8081/test/browser/less/bg);
}
.values {
  url: url('http://172.17.10.24:8081/test/browser/less/Trebuchet');
}
#data-uri {
  uri: url('http://172.17.10.24:8081/test/data/image.jpg');
}
#data-uri-guess {
  uri: url('http://172.17.10.24:8081/test/data/image.jpg');
}
#data-uri-ascii {
  uri-1: url('http://172.17.10.24:8081/test/data/page.html');
  uri-2: url('http://172.17.10.24:8081/test/data/page.html');
}
#data-uri-toobig {
  uri: url('http://172.17.10.24:8081/test/data/data-uri-fail.png');
}
#svg-functions {
